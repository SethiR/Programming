...
public class userInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static userInfo fromByteBuffer(
   ...
   private int age;
   private example.avro.mailing_address address;
   ...
   */
  public userInfo(java.lang.CharSequence username, java.lang.Integer age, example.avro.mailing_address address) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: address = (example.avro.mailing_address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public example.avro.mailing_address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(example.avro.mailing_address value) {
    this.address = value;
  }
   ...
   */
  public static example.avro.userInfo.Builder newBuilder() {
    return new example.avro.userInfo.Builder();
  }
   ...
   * @return A new userInfo RecordBuilder
   */
  public static example.avro.userInfo.Builder newBuilder(example.avro.userInfo.Builder other) {
    if (other == null) {
      return new example.avro.userInfo.Builder();
    } else {
      return new example.avro.userInfo.Builder(other);
    }
  }
   ...
   * @return A new userInfo RecordBuilder
   */
  public static example.avro.userInfo.Builder newBuilder(example.avro.userInfo other) {
    if (other == null) {
      return new example.avro.userInfo.Builder();
    } else {
      return new example.avro.userInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<userInfo>
    ...
    private int age;
    private example.avro.mailing_address address;
    private example.avro.mailing_address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro.userInfo.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = example.avro.mailing_address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro.userInfo other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder setAddress(example.avro.mailing_address value) {
     ...
     * @return This builder.
     */
    public example.avro.mailing_address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(example.avro.mailing_address.newBuilder(address));
        } else {
          setAddressBuilder(example.avro.mailing_address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public example.avro.userInfo.Builder setAddressBuilder(example.avro.mailing_address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.userInfo.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public userInfo build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[2] ? this.address : (example.avro.mailing_address) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new example.avro.mailing_address();
      }
